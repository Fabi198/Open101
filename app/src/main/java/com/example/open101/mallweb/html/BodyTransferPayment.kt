...
object BodyTransferPayment {
    ...
    fun body(client: Client, address: Address, order: Order, context: Context): String {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "    <p>Hola ${client.name}, Gracias por tu pedido. Luego de realizada la transferencia, recorda enviar el comprobante como respuesta a este mail.</p>\n" +
