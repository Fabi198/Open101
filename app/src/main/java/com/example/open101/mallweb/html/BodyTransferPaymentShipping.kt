...
object BodyTransferPaymentShipping {
    ...
    fun body(client: Client, address: Address, addressShipping: Address, order: Order, context: Context): String {
        ...
        return "<!DOCTYPE html>\n" +
                ...
                "    <p>Hola ${client.name}, Gracias por tu pedido. Recorda enviar el comprobante de la transferencia como respuesta a este mail.</p>\n" +
                "    <p>Tu pedido llegara según las indicaciónes de la empresa a cargo del mismo, a partir del momento en que recepcionemos el comprobante</p>\n" +
                "    \n" +
                ...
                "\n" +
                "  <div class=\"card\">\n" +
                "    <h2 class=\"santander-rio\">Santander Rio</h2>\n" +
                "    <p>Titular: Polytech S.A.</p>\n" +
                "    <p>Cuenta Corriente: 432 000743 8</p>\n" +
                "    <p>CUIT: 33643358749</p>\n" +
                "    <p>CBU: 0720432020000000074386</p>\n" +
                "    <p>Alias: Sombra.Par.Foto</p>\n" +
                "  </div>\n" +
                "</body>\n" +
                "</html>\n"
    }
